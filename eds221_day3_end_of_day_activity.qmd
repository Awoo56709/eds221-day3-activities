...
for (i in seq_along(type_fish)) {
  if (type_fish[i] == "goldfish") {
    num_fish <- num_fish[i] / total_fish
  } else if (type_fish[i] == "tetras") {
    num_fish <- num_fish[i] / total_fish
} else if (type_fish[i] == "guppies") {
    num_fish <- num_fish[i] / total_fish
} else if (type_fish[i] == "mollies") {
    num_fish <- num_fish[i] / total_fish
}
  print(paste("The proportion of", type_fish, "is", num_fish[i]))
}
...
for (i in month.name) {
  if month.name == "January") {
    print(paste(month.name, "is month 1"))
  }
}
```
